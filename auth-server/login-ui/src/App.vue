...
// Detect if running behind API gateway (path contains /ecso)
const behindGateway = window.location.pathname.startsWith('/ecso')
const gatewayPrefix = behindGateway ? '/ecso/auth' : ''
