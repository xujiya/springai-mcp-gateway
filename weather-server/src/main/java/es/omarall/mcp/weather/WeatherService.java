...
public class WeatherService {
    ...
    @McpTool(name = "getWeatherForecast", description = "Get weather forecast for a specific latitude/longitude. " +
    ...
    @McpTool(name = "getAlerts", description = "Get weather alerts for a US state. " +
